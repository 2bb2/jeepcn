...
function sendMail($subject,$msghtml,$sendAddress)
{
    ...
    $mail->Username = '15110860310';      //发信人的邮箱用户名
    $mail->Password = 'l2160830'; //新注册邮箱，客户端授权码
    /*内容信息*/
    $mail->IsHTML(true);               //指定邮件内容格式为：html
    $mail->CharSet = "UTF-8";          //编码
    $mail->From = '15110860310@163.com';       //发件人完整的邮箱名称
    $mail->FromName = "刘东开发技术小组";      //发信人署名
...
function linkMongo(){
   $mongo=new MongoClient('mongodb://admin:root@127.0.0.1:27017/');
    //连接库
    $database=$mongo->test;
    //连接表
    $con=$database->mobile;
